...
gulp.task('build',
  gulp.series(clean, gulp.parallel(pages, complieEjs), gulp.series(sass, images, inline)));
...
function watch() {
  gulp.watch(['src/pages/**/*.html', 'src/pages/**/*.ejs']).on('all', gulp.series(gulp.parallel(pages, complieEjs), inline, browser.reload));
  gulp.watch(['src/layouts/**/*', 'src/partials/**/*']).on('all', gulp.series(resetPages, pages, inline, browser.reload));
  gulp.watch(['../scss/**/*.scss', 'src/assets/scss/**/*.scss']).on('all', gulp.series(resetPages, sass, gulp.parallel(pages, complieEjs), inline, browser.reload));
